...
import type { LeagueStateDTO, MatchEventDTO, PlayerStatsDTO, ServerMessage } from "@/lib/types";
                  ...
                  {state.players.map((p) => {
                    ...
                    return (
                      <tr
                        ...
                        title={`View ${p.name}'s stats`}
                      >
                        <td>
                          <div className="player-name">
                            {p.name} <span className="stats-hint">stats ›</span>
                          </div>
